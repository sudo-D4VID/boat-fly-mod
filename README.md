...
## Features
- 🪶 **Ultra-lightweight** – single mixin, zero Fabric API dependency
...
2. Download `boatfly-1.0.0.jar` from the [Releases](https://github.com/sudo-D4VID/boat-fly-mod/releases) page
...
## How it works
The mod uses a single **Fabric Mixin** injected into `BoatEntity#tick()`.  
On each tick, if the local player is riding a boat it checks:
